        ...
        >
          ...
          <defs>
            <filter id="tube3D" x="-20%" y="-20%" width="140%" height="140%">
              ...
              {/* 2. Pink Inner Shadow (Bottom-Right edge) */}
              <feOffset in="SourceAlpha" dx="-10" dy="-15" result="offsetAlphaPink" />
              <feGaussianBlur in="offsetAlphaPink" stdDeviation="15" result="blurPink" />
              <feComposite operator="out" in="SourceAlpha" in2="blurPink" result="inversePink" />
              <feFlood floodColor="#ffb2e6" floodOpacity="1" result="colorPink" />
              <feComposite operator="in" in="colorPink" in2="inversePink" result="shadowPink" />

              {/* 3. Merge layers */}
              <feMerge>
                <feMergeNode in="dropShadow" />
                <feMergeNode in="SourceGraphic" />
                <feMergeNode in="shadowPink" />
              </feMerge>
            </filter>
          </defs>
